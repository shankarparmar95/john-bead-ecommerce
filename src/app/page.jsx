    ...
    <div className="flex flex-col min-h-screen">
        ...
        <div className="container mx-auto py-3 px-4 flex items-center justify-between">
          ...
          <div className="flex-1 max-w-xl relative">
            <Input
              ...
              className="w-full border border-gray-300 rounded-md pr-10 h-9"
            />
      ...
      <main>
        ...
        <section className="py-8 bg-white">
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center gap-8 border border-gray-300 rounded-md overflow-hidden">
      ...
      {/* Footer */}
      <footer className="bg-white pt-8 pb-4 border-t border-gray-300 mt-8">
        <div className="container mx-auto px-4">
            ...
            <div>
              ...
              <div className="flex">
                <Input
                  ...
                  className="rounded-l-md border-gray-300 border-r-0 h-8 text-xs"
                />
